...
def net_builder(net_name, from_name: bool, net_conf=None):
    ...
    if from_name:
        ...
        if net_name == 'WideResNet':
            ...
            import models.nets.wrn_stl10 as net
            builder = getattr(net, 'build_WideResNet')()
        else:
...
def ssl_path(root_dir, train_db_name):
    if train_db_name == 'cifar10':
        train_db_name = 'cifar-10'
    elif train_db_name == 'cifar20':
        train_db_name = 'cifar-20'
    elif train_db_name == 'stl10':
        train_db_name = 'stl-10'
    else:
        raise ValueError('Invalid train_db_name')
    base_dir = os.path.join(root_dir, train_db_name)
    return base_dir
