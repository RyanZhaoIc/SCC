...
class CIFAR10(Dataset):
    ...
    def __init__(self, root=MyPath.db_root_dir(), split='train', transform=None,
...
class CIFAR20(CIFAR10):
    ...
    def __init__(self, root=MyPath.db_root_dir(), split='train', transform=None,
                 download=False, indices=None):
        super(CIFAR20, self).__init__(root, split=split, transform=transform,
                                      download=download, indices=indices)
...
class CIFAR100(CIFAR10):
    ...
    def __init__(self, root=MyPath.db_root_dir(), split='train', transform=None,
                 download=False, indices=None):
        super(CIFAR100, self).__init__(root, split=split, transform=transform,
                                       download=download, indices=indices)
